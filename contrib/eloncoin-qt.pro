...
RESOURCES += src/qt/eloncoin.qrc src/qt/eloncoin_locale.qrc

TRANSLATIONS += src/qt/locale/eloncoin_bg.ts \
                src/qt/locale/eloncoin_de.ts \
                src/qt/locale/eloncoin_en.ts \
                src/qt/locale/eloncoin_es.ts \
                src/qt/locale/eloncoin_fi.ts \
                src/qt/locale/eloncoin_fr.ts \
                src/qt/locale/eloncoin_it.ts \
                src/qt/locale/eloncoin_ja.ts \
                src/qt/locale/eloncoin_pl.ts \
                src/qt/locale/eloncoin_pt.ts \
                src/qt/locale/eloncoin_ru.ts \
                src/qt/locale/eloncoin_sk.ts \
                src/qt/locale/eloncoin_sv.ts \
                src/qt/locale/eloncoin_vi.ts \
                src/qt/locale/eloncoin_zh_CN.ts \
                src/qt/locale/eloncoin_zh_TW.ts
