...
pkgdatadir = $(datadir)/eloncoin
pkgincludedir = $(includedir)/eloncoin
pkglibdir = $(libdir)/eloncoin
pkglibexecdir = $(libexecdir)/eloncoin
...
CONFIG_HEADER = $(top_builddir)/src/config/eloncoin-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/eloncoin-config.h.in \
...
ACLOCAL = ${SHELL} /home/ksk/Works/2021/ElonCoin/works/ubuntu_works/ElonCoin-1.0.0/build-aux/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
ARM_CRC_CXXFLAGS = 
AUTOCONF = ${SHELL} /home/ksk/Works/2021/ElonCoin/works/ubuntu_works/ElonCoin-1.0.0/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/ksk/Works/2021/ElonCoin/works/ubuntu_works/ElonCoin-1.0.0/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/ksk/Works/2021/ElonCoin/works/ubuntu_works/ElonCoin-1.0.0/build-aux/missing automake-1.16
AVX2_CXXFLAGS = -mavx -mavx2
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = eloncoin-cli
BITCOIN_DAEMON_NAME = eloncoind
BITCOIN_GUI_NAME = eloncoin-qt
BITCOIN_TX_NAME = eloncoin-tx
...
MAINT = 
MAKEINFO = ${SHELL} /home/ksk/Works/2021/ElonCoin/works/ubuntu_works/ElonCoin-1.0.0/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = eloncoin
PACKAGE_BUGREPORT = https://github.com/lightlord1233/Eloncoin/issues
PACKAGE_NAME = ELONCOIN Core
PACKAGE_STRING = ELONCOIN Core 1.0.0
PACKAGE_TARNAME = eloncoin
PACKAGE_URL = https://eloncoin.org/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /home/ksk/Works/2021/ElonCoin/works/ubuntu_works/ElonCoin-1.0.0
abs_srcdir = /home/ksk/Works/2021/ElonCoin/works/ubuntu_works/ElonCoin-1.0.0
abs_top_builddir = /home/ksk/Works/2021/ElonCoin/works/ubuntu_works/ElonCoin-1.0.0
abs_top_srcdir = /home/ksk/Works/2021/ElonCoin/works/ubuntu_works/ElonCoin-1.0.0
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/ksk/Works/2021/ElonCoin/works/ubuntu_works/ElonCoin-1.0.0/build-aux/install-sh
...
DIST_CONTRIB = $(top_srcdir)/contrib/eloncoin-cli.bash-completion \
	       $(top_srcdir)/contrib/eloncoin-tx.bash-completion \
	       $(top_srcdir)/contrib/eloncoind.bash-completion \
...
WINDOWS_PACKAGING = $(top_srcdir)/share/pixmaps/eloncoin.ico \
  $(top_srcdir)/share/pixmaps/nsis-header.bmp \
  $(top_srcdir)/share/pixmaps/nsis-wizard.bmp \
  $(top_srcdir)/doc/README_windows.txt

LINUX_PACKAGING = $(top_srcdir)/share/pixmaps/eloncoin16.xpm \
  $(top_srcdir)/share/pixmaps/eloncoin32.xpm \
  $(top_srcdir)/share/pixmaps/eloncoin128.png
...
COVERAGE_INFO = baseline.info \
  test_eloncoin_filtered.info total_coverage.info \
  baseline_filtered.info functional_test.info functional_test_filtered.info \
  test_eloncoin_coverage.info test_eloncoin.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/ELONCOIN-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings \
...
src/config/eloncoin-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/eloncoin-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/eloncoin-config.h
$(top_srcdir)/src/config/eloncoin-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/eloncoin-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/ELONCOIN-Qt: all-recursive
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/ELONCOIN-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/ELONCOIN-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_eloncoin.info: baseline_filtered.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c $(LCOV_OPTS) -d $(abs_builddir)/src -t test_eloncoin -o $@
#	$(LCOV) -z $(LCOV_OPTS) -d $(abs_builddir)/src

#test_eloncoin_filtered.info: test_eloncoin.info
#	$(abs_builddir)/contrib/filter-lcov.py $(LCOV_FILTER_PATTERN) $< $@
#	$(LCOV) -a $@ $(LCOV_OPTS) -o $@

#functional_test.info: test_eloncoin_filtered.info
...
#test_eloncoin_coverage.info: baseline_filtered.info test_eloncoin_filtered.info
#	$(LCOV) -a $(LCOV_OPTS) baseline_filtered.info -a test_eloncoin_filtered.info -o $@

#total_coverage.info: test_eloncoin_filtered.info functional_test_filtered.info
#	$(LCOV) -a $(LCOV_OPTS) baseline_filtered.info -a test_eloncoin_filtered.info -a functional_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_eloncoin.coverage/.dirstamp:  test_eloncoin_coverage.info
...
#cov: test_eloncoin.coverage/.dirstamp total.coverage/.dirstamp
...
clean-local: clean-docs
	rm -rf coverage_percent.txt test_eloncoin.coverage/ total.coverage/ test/tmp/ cache/ $(OSX_APP)
