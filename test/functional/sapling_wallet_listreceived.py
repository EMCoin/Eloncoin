...
# Copyright (c) 2020The PIVX developers
...
class ListReceivedTest (ElonCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 EMC.
        ...
        # Send 1 EMC to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 EMC sending them all (fee is 0.1 EMC)
        ...
        # Confirm transaction (2 EMC from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 EMC, send 0.6 EMC + 0.05 EMC fee
