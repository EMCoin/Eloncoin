...
from test_framework.test_framework import ElonCoinTier2TestFramework
...
class MasternodeGovernanceBasicTest(ElonCoinTier2TestFramework):
    ...
    def run_test(self):
        ...
        firstProposalLink = "https://forum.eloncoin.org/t/test-proposal"
