#!/usr/bin/env python3
# Copyright (c) 2019The PIVX developers
...
class BudgetProposalTest(ElonCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test with invalid ELONCOIN address")
        assert_raises_rpc_error(-5, "Invalid ELONCOIN address", self.nodes[0].preparebudget,
        ...
        assert_raises_rpc_error(-8, "Invalid amount - Payment of %.8f is less than minimum 10 EMC allowed" % invalid_amt, self.nodes[0].preparebudget,
