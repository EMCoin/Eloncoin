#!/usr/bin/env python3
# Copyright (c) 2021The PIVX developers
...
class BlockIndexStatsTest(ElonCoinTestFramework):
    ...
    def send_tx(self, node_from, node_to, fee, fFromShield, fToShield):
        if not fFromShield and not fToShield:
            ...
            # add 1 EMC "change" output 50% of the times
    ...
    def run_test(self):
        ...
        # miner creates 20 notes of 10 EMC + 9 notes of 5 EMC + 1 note of 4 EMC (using 1.0 fee)
