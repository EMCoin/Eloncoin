#!/usr/bin/env python3
# Copyright (c) 2020 The ELONCOIN Core developers
...
class SaplingMempoolTest(ElonCoinTestFramework):
    ...
    def run_test(self):
        ...
        # miner sends a 10 EMC note to Alice
        ...
        # miner sends another 10 EMC note to Alice
