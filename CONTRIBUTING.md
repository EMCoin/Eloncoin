...
[Translation Process](https://github.com/eloncoin-project/eloncoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the ELONCOIN Core project, and is not to be
confused with overall ELONCOIN Network Protocol consensus changes.
...
Where a patchset proposes to change the ELONCOIN consensus, it must have been
