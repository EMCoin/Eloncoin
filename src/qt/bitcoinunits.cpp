...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(EMC);
    unitlist.append(mEMC);
    unitlist.append(uEMC);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case EMC:
        return QString("eloncoin");
    case mEMC:
        return QString("meloncoin");
    case uEMC:
        return QString::fromUtf8("ueloncoin");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool isZemc)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZEMC)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZEMC);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZEMC)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZEMC));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
