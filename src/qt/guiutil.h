...
/** Utility functions used by the ELONCOIN Qt UI.
 */
namespace GUIUtil
{
...
// Render ELONCOIN addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZemc = false);
QString formatBalanceWithoutHtml(CAmount amount, int nDisplayUnit = 0, bool isZemc = false);
...
// Parse "eloncoin:" URI into recipient object, return true on successful parsing
