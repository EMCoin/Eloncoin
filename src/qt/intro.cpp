...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || gArgs.GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("ELONCOIN Core"),
     ...
     * override -datadir in the eloncoin.conf file in the default data directory
     * (to be consistent with eloncoind behavior)
     */
