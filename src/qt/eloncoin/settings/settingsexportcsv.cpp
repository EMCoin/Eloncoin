...
#include "qt/eloncoin/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(ELONCOINGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("ELONCOIN_tx_csv_export(*.csv)") : tr("ELONCOIN_addresses_csv_export(*.csv)"),
                                        nullptr);
