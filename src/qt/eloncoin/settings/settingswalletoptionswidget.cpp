...
#include "qt/eloncoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/eloncoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(ELONCOINGUI* _window, QWidget *parent) :
