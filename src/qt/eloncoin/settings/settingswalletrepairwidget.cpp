...
#include "qt/eloncoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/eloncoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(ELONCOINGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to ELONCOINGUI::handleRestart()
