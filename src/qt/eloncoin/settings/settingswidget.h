...
#include "qt/eloncoin/settings/settingsbackupwallet.h"
#include "qt/eloncoin/settings/settingsexportcsv.h"
#include "qt/eloncoin/settings/settingsbittoolwidget.h"
#include "qt/eloncoin/settings/settingssignmessagewidgets.h"
#include "qt/eloncoin/settings/settingswalletrepairwidget.h"
#include "qt/eloncoin/settings/settingswalletoptionswidget.h"
#include "qt/eloncoin/settings/settingsmainoptionswidget.h"
#include "qt/eloncoin/settings/settingsdisplayoptionswidget.h"
#include "qt/eloncoin/settings/settingsmultisendwidget.h"
#include "qt/eloncoin/settings/settingsinformationwidget.h"
#include "qt/eloncoin/settings/settingsconsolewidget.h"
...
public:
    explicit SettingsWidget(ELONCOINGUI* parent);
    ~SettingsWidget();
