...
#include "qt/eloncoin/settings/settingsnetworkwidget.h"
#include "qt/eloncoin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/eloncoin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(ELONCOINGUI* _window, QWidget *parent) :
