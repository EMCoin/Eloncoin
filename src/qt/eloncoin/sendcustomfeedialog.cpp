...
#include "qt/eloncoin/sendcustomfeedialog.h"
#include "qt/eloncoin/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(ELONCOINGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &ELONCOINGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
