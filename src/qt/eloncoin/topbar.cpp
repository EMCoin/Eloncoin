...
#include "qt/eloncoin/forms/ui_topbar.h"
#include "qt/eloncoin/lockunlock.h"
#include "qt/eloncoin/qtutils.h"
#include "qt/eloncoin/receivedialog.h"
#include "qt/eloncoin/loadingdialog.h"
#include "askpassphrasedialog.h"

#include "bitcoinunits.h"
#include "qt/eloncoin/balancebubble.h"
...
TopBar::TopBar(ELONCOINGUI* _mainWindow, QWidget *parent) :
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("ELONCOIN")
    updateDisplayUnit();
...
void TopBar::updateBalances(const interfaces::WalletBalances& newBalance)
{
    ...
    // EMC Total
    QString totalEmc = GUIUtil::formatBalance(newBalance.balance, nDisplayUnit);
    ...
    ui->labelImmatureEmc->setText(GUIUtil::formatBalance(newBalance.immature_balance, nDisplayUnit));
}
