...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, ELONCOINGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, ELONCOINGUI* gui, double posX = 3);
