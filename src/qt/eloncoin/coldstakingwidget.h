...
#include "qt/eloncoin/sendmultirow.h"
#include "qt/eloncoin/coldstakingmodel.h"
#include "qt/eloncoin/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(ELONCOINGUI* parent);
    ~ColdStakingWidget();
