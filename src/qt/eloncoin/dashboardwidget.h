...
#include "qt/eloncoin/txviewholder.h"
...
#include "config/eloncoin-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalEmc = 0;
    qint64 totalZemc = 0;
    QList<qreal> valuesEmc;
    QList<qreal> valueszEmc;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(ELONCOINGUI* _window);
    ~DashboardWidget();
