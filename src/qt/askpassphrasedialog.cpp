...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            ELONCOINGUI* window = static_cast<ELONCOINGUI*>(parentWidget());
...
{
    ELONCOINGUI* gui = static_cast<ELONCOINGUI*>(parentWidget());
...
{
    hide();
    static_cast<ELONCOINGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("ELONCOIN will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your EMCs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
