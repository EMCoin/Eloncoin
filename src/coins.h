...
public:
    ...
    /**
     * Amount of eloncoin coming in to a transaction
...
// ELONCOIN: When check is false, this assumes that overwrites are never possible due to BIP34 always in effect
