/* src/config/eloncoin-config.h.  Generated from eloncoin-config.h.in by configure.  */
/* src/config/eloncoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://github.com/lightlord1233/Eloncoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "ELONCOIN Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "ELONCOIN Core 1.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "eloncoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://eloncoin.org/"
