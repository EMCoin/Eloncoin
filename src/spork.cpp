...
std::vector<CSporkDef> sporkDefs = {
    MAKE_SPORK_DEF(SPORK_5_MAX_VALUE,                       1000),          // 1000 EMC
...
// ELONCOIN: on startup load spork values from previous session if they exist in the sporkDB
...
int CSporkManager::ProcessSporkMsg(CSporkMessage& spork)
{
    ...
    // ELONCOIN: add to spork database.
