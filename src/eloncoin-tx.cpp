...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help")) {
        ...
        std::string strUsage = _("ElonCoin Core eloncoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  eloncoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded eloncoin transaction") + "\n" +
                               "  eloncoin-tx [options] -create [commands]   " + _("Create hex-encoded eloncoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded eloncoin transaction
