...
- #2249 Make box of ELONCOIN Send address return to purple when it's empty (PicklesRcool)
...
- #2170 Better eloncoin.conf Masternode data error notification (furszy)
