...
Run with the `-testnet` option to run with "play EMCs (tEMC)" on the test network, if you
...
([`valgrind.supp`](https://github.com/lightlord1233/Eloncoin/blob/master/contrib/valgrind.supp))
...
- BitcoinMiner : Generates EMCs (if wallet is enabled).
