...
This document provides guidelines for internationalization of the ELONCOIN Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `eloncoin_en.ts` remains unchanged.
